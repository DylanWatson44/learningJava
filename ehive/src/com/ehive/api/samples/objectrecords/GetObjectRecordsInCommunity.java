...
public class GetObjectRecordsInCommunity {
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getObjectRecordsInCommunity(communityId, query, hasImages, sort, direction, offset, limit);
