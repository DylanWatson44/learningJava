...
public class GetObjectRecordsInEHive {
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getObjectRecordsInEHive(query, hasImages, sort, direction, offset, limit);
		
		// Print some output using the returned object records collection
		printObjectRecordsInEHiveInfo(objectRecordsCollection);
		
	}
	
	private static void printObjectRecordsInEHiveInfo(ObjectRecordsCollection objectRecordsCollection) {
