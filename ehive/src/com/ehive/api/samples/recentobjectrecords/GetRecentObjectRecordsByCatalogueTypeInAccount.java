package com.ehive.api.samples.recentobjectrecords;
...
public class GetRecentObjectRecordsByCatalogueTypeInAccount {	
	...
	private final static Integer accountId = 3406;
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getRecentObjectRecordsInAccount(accountId, hasImages, catalogueType, offset, limit);
