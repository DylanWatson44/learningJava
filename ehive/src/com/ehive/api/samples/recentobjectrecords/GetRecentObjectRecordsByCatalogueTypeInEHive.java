...
public class GetRecentObjectRecordsByCatalogueTypeInEHive {	
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getRecentObjectRecordsInEHive(hasImages, catalogueType, offset, limit);
