...
public class GetRecentObjectRecordsInAccount {
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getRecentObjectRecordsInAccount(accountId, hasImages, offset, limit);
