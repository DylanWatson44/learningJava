...
public class GetInterestingObjectRecordsByCatalogueTypeInCommunity {
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getInterestingObjectRecordsInCommunity(communityId, hasImages, catalogueType, offset, limit);
