...
public class GetInterestingObjectRecordsByCatalogueTypeInAccount {
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getInterestingObjectRecordsInAccount(accountId, hasImages, catalogueType, offset, limit);
