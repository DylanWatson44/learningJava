package com.ehive.api.samples.interestingobjectrecords;
...
public class GetInterestingObjectRecordsByCatalogueTypeInAccountInCommunity {
	...
	private static String catalogueType = "art";
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getInterestingObjectRecordsInAccountInCommunity(communityId, accountId, hasImages, catalogueType, offset, limit);
	...
	private static void printObjectRecordInfo(ObjectRecordsCollection objectRecordsCollection) {
		...
		for (ObjectRecord objectRecord : objectRecordsCollection.getObjectRecords()) {
			stringBuilder.append(objectRecord.getCatalogueType().toUpperCase() + " record...\n\n");
