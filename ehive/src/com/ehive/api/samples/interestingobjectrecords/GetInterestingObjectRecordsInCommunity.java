...
public class GetInterestingObjectRecordsInCommunity {
	...
	public static void main(String[] args) throws EHiveApiException, EHiveFatalServerException, EHiveNotFoundException, EHiveUnauthorizedException, EHiveForbiddenException {
		...
		ObjectRecordsCollection objectRecordsCollection = eHiveApi.getInterestingObjectRecordsInCommunity(communityId, hasImages, offset, limit);
